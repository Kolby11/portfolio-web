...
<!-- Desktop navbar -->
<div class="fixed top-0 z-50 hidden h-20 w-full items-center justify-between px-8 py-6 backdrop-blur-lg sm:flex">
        ...
        <li>
          <a
            ...
            class="items-center justify-center px-3 text-xl {i === sections.length - 1
              ? ''
              : 'border-light-secondary border-r dark:border-dark-secondary'}"
