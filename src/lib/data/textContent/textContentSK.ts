...
export const TextContentSK: TextContent = {
  seo: {
    description:
  ...
  navbar: { home: 'Domov', about: 'O mne', experience: 'Skúsenosti', projects: 'Projekty', contact: 'Kontakt' },
  home: {
    title: 'Domov',
    description:
      'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Odio hic explicabo consectetur est eius accusamus quas eveniet placeat non illum dolores modi sint accusantium porro nesciunt in, maiores eligendi similique.',
  },
  about: {
    title: 'O mne',
    ...
    timeline: {
      ...
      sections: [
        ...
        {
          title: 'Ukončenie štúdia na strednej škole',
          description:
  ...
  experience: {
    slideshowItems: [
      ...
      },
      {
        ...
        description: 'Skúsenosti s tvorením mobilných aplikácií mám čisto z vlastných projektov',
      },
      {
